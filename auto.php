...
function call($addr) {
    ...
    $c = curl_init("https://japakar.com/");
    curl_setopt($c, CURLOPT_REFERER, "https://japakar.com/");
...
for($i=0; $i<100; $i++) {
    ...
    echo "[" . date("H:i:s") . "] Enteni sak menit cok sabar..\n";
    sleep(60);
}
